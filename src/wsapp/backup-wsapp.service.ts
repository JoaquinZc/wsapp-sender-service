...
import { BackupWsapp, BackupWsappDocument, BackupWsappStatus } from './schema/backup-wsapp.schema';
...
export class BackupWsappService {
  constructor(@InjectModel(BackupWsapp.name) private backupWsappModel: Model<BackupWsapp>) {}
